...
/** Client-only: avoids hydration mismatch when browser extensions inject attributes (e.g. bis_skin_checked). */
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-16 text-center">
      ...
      <p className="mt-4 text-secondary">
        ...
        qualification and matches; everyone sees live rankings, elimination matches, and
        field target boards.
      </p>
